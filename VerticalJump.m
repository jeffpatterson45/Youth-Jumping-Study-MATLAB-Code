function [ avgPower, peakPower ] = VerticalJump(Time, Fz, FrameNumbers)
%% Vertical Jump
% Created by Jeff Patterson, 4-18-16
%   Describe input/output variables
% INPUT: 
...
% Don't need Fx and Fy for vertical jump
...
for i = 1:3
    ...
    while Start < Stop;
        ...
        Power(Begin) = Fz_Force_Offset(Start)*VelocityZ(Begin);
